...
# for low tier
pred.boslt <- nextYearPred(boxrltnsats, 1987)$mean

# for middle tier
pred.bosmt <- nextYearPred(boxrmtnsats, 1987)$mean
...
pred.chiht <- nextYearPred(chxrhtnsats, 1992)$mean

# predict for low tier
pred.chilt <- nextYearPred(chxrltnsats, 1992)$mean

# predict for middle tier
pred.chimt <- nextYearPred(chxrmtnsats, 1992)$mean
...
# predict for high tier
pred.laht <- nextYearPred(laxrhtnsats, 1987)$mean

# predict for low tier
pred.lalt <- nextYearPred(laxrltnsats, 1987)$mean

# predict for middle tier
pred.lamt <- nextYearPred(laxrmtnsats, 1987)$mean
...
# predict for high tier
pred.nyht <- nextYearPred(nyxrhtnsats, 1987)$mean

# predict for low tier
pred.nylt <- nextYearPred(nyxrltnsats, 1987)$mean

# predict for middle tier
pred.nymt <- nextYearPred(nyxrmtnsats, 1987)$mean
...
# predict for high tier
pred.sfht <- nextYearPred(sfxrhtnsats, 1987)$mean

# predict for low tier
pred.sflt <- nextYearPred(sfxrltnsats, 1987)$mean

# predict for middle tier
pred.sfmt <- nextYearPred(sfxrmtnsats, 1987)$mean
